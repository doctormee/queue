...
1. Порядок установки
    ...
    Для запуска тестов выполните следующую команду: `make gtest && make test`
    
    Для просмотра покрытия после запуска тестов выполните следующую команду: `make cov`
    
    Для того, чтобы сгенерировать исполняемый файл и запустить тесты, выполните следующую команду: `make`
